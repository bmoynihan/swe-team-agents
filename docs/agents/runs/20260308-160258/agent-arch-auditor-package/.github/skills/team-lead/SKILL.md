...
name: team-lead
description: >
  Manager-only orchestration skill for the Team Lead agent. Boots and maintains the task artifact set,
  delegates work to specialist agents, enforces one-PR scope, and converges on objective evidence before
  handing off to a human maintainer.
